...
class Factorial extends AbstractProvider
{
    ...
    {
        return 'https://api.factorialhr.com/oauth/authorize';
    }
    ...
    {
        return 'https://api.factorialhr.com/oauth/token';
    }
    ...
    {
        return new FactorialResourceOwner($response);
    }
